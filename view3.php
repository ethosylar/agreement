...
$stmt = $connection->prepare("SELECT * FROM terminate WHERE (id = ? OR filename IS NULL) AND department = ?");
...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('No data found for this entry.'); window.location.href='terminate.php';</script>";
    exit();
}
...
<div class="container">
    <a href="terminate.php" class="back-button"><i class='bx bx-arrow-back'></i></a>
